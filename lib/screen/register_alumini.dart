...
class RegisterAlumini extends StatefulWidget {
  RegisterAlumini(this.submitFn, this.issLoading);
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                                ...
                                labelText: 'Please enter your roll Number',
                                border: const OutlineInputBorder(
                                    borderRadius:
                                        BorderRadius.all(Radius.circular(40)))),
                          ),
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                                prefixIcon: Icon(Icons.lock),
                                labelText: 'Please enter your confirm password',
                                border: const OutlineInputBorder(
                                    borderRadius:
                                        BorderRadius.all(Radius.circular(40)))),
                          ),
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                                ...
                                labelText: 'Please enter your Job_Company',
                                border: const OutlineInputBorder(
                                    borderRadius:
                                        BorderRadius.all(Radius.circular(40)))),
                          ),
